...
public class GenericDataBaseLogic {
...

    {
        ...
        tvDbList.add(new TV(1445, "4k", 67, 1, "Samsung Fd", "X1", "Samsung", 222, LocalDate.now()));
    }
    ...
    {
        lightBDbList.add(new LightBulb("red", 1234, "455W", "23", 1232432, "Xiaomi", "Mi Pro", " Xiaomi", 222, LocalDate.now()));
    }
